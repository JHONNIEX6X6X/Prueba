		...
		<div class="card-body">
			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-sm-2">
						<button class="btn btn-sm btn-primary mt-4"><i class="fa fa-filter"></i> Filtrar</button>
						<button class="btn btn-sm btn-success mt-4" onclick="_Print()"><i class="fa fa-print"></i> Imprimir</button>
					</div>
				</div>
			</div>
			</form>
			...
			<div id="report-tbl-holder">
				...
				<div class="callout">
					<div class="row">
						<div class="col-md-6">
							<dl>
								<dt>Título de la Conferencia</dt>
				...
				<table id="report-tbl" class="table table-stripped table-bordered">
					...
					<tbody>
						...
						<?php if($qry->num_rows <=0): ?>
							<tr>
								<th class="text-center" colspan="6">Sin Datos.</th>
							</tr>
						<?php endif; ?>
					</tbody>
				</table>
