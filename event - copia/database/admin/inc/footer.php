...
<footer class="main-footer text-sm">
        <strong>Jhonnier Valencia © <?php echo date('Y') ?>. 
        <!-- <a href=""></a> -->
        </strong>
        Conferencias.
    ...
    <div class="daterangepicker ltr show-ranges opensright">
      <div class="ranges">
        <ul>
          ...
          <li data-range-key="Last 7 Days">ultimos 7 dias</li>
          <li data-range-key="Last 30 Days">ultimos 30 dias</li>
          <li data-range-key="This Month">este mes</li>
          <li data-range-key="Last Month">ultimo mes</li>
